<div class="container-fluid p-2">
    ...
    <div class="row" id = "visor">
        ...
        <div class="col-md-12 col-md-push-4 p-l-1" id="espacio">

            <div class="info-flotante">
                <div class="col-md-12 col-md-pull-9 p-r-0 scrollbar" id="panel">
                                ...
                                <div class="card">
                                    <div class="card-body p-1">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 themed-grid-col"><select class="selectpicker" data-style="data-selected-text-format" id="cbxBD">
            ...
            <div id="mapa"> </div>
            <div class="legenda-anio" id="controlDespl"></div>
                ...
                <div class="card-body  p-1" style="z-index: 999999; background-color: white">
                    <div class="card" style="z-index: 999999" id="print">
                        <div class="contLeyenda">
                            <div class="leyenda_1"></div> De <span id="leyenda_1_min">0</span> a <span id="leyenda_1_max">0</span>
                        </div>
                        <div class="contLeyenda">
                            <div class="leyenda_2"></div> De <span id="leyenda_2_min">0</span> a <span id="leyenda_2_max">0</span>
                        </div>
                        <div class="contLeyenda">
                            <div class="leyenda_3"></div> De <span id="leyenda_3_min">0</span> a <span id="leyenda_3_max">0</span>
                        </div>
                        <div class="contLeyenda">
                            <div class="leyenda_4"></div> De <span id="leyenda_4_min">0</span> a <span id="leyenda_4_max">0</span>
                        </div>
                        <div class="contLeyenda">
                            <div class="leyenda_5"></div> De <span id="leyenda_5_min">0</span> a <span id="leyenda_5_max">0</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
	preCarga = function() {
		...
		var centrar = L.easyButton('<img src="assets/images/update_.png">', function(btn, map){
		    var centro = [-15,-74];
